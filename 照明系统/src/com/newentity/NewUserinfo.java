...
public class NewUserinfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public NewUserinfo(Integer userinfoid, String username, String password, Integer membertype) {
	...
	/** full constructor */
	public NewUserinfo(Integer userinfoid, String username, String phone, String email, String qq, String weixin,
			String weibo, String taobao, String zhifubao, String password, Integer membertype, Integer state,
