...
(function() {
    ...
    CityList.prototype._initContainer = function () {
        ...
        businessDom.style.display = "none";   
		...
		container.appendChild(document.createTextNode('街道'));
        /*第一步 表单操作*/
        ...
        function dispatchCityClick(option){
             ...
             */
             if(option.area_type == 1){
                $("#province").attr("value",option.title);
             }
             if(option.area_type == 2){
                if(option.title == "北京市"){
                    $("#province").attr("value",option.title);
                    $("#city").attr("value",option.title);
                }else if(option.title == "上海市"){
                    $("#province").attr("value",option.title);
                    $("#city").attr("value",option.title);
                }else if(option.title == "天津市"){
                    $("#province").attr("value",option.title);
                    $("#city").attr("value",option.title);
                }else if(option.title == "重庆市"){
                    $("#province").attr("value",option.title);
                    $("#city").attr("value",option.title);
                }else{
                    $("#city").attr("value",option.title);
        	...
        	if(option.area_type == 3){
                $("#borough").attr("value",option.title);
             }
        ...
        /*baidu.on(detail, "mouthout",function(){
            var x = $("#detailId").val();
            alert(x);
        })*/
        //myCityListObject.addEventListener("cityclick", function(e) {  alert(e.area_name);  });
