								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown">
										<a class="dropdown-toggle" href="#"><i class="et-browser"></i>
											<s:property value="#producttypesL1.producttypename"/>
											<s:property value="#producttypesL1.producttypeid"/>
											<s:property value="hmIdL1AndProducttypesL2.value.size"/>
											<s:property value="hmIdL1AndProducttypesL2.get(#producttypesL1.producttypeid).size"/></a>
										<ul class="dropdown-menu">
											<s:iterator value="hmIdL1AndProducttypesL2.get(#producttypesL1.producttypeid)" id='entryValue'>
											<li>
												<a href="2.html"><s:property value="#entryValue.producttypename"/></a>
											</li>
											</s:iterator>
										</ul>
									</li>	
			...
			<div class="container">
				...
				<div class="owl-carousel buttons-autohide controlls-over nomargin"
					...
					<s:iterator value="%{lstHomeslides}" id='homeslides'>
						<div>
							<a href="#"> <img class="img-responsive"
								src="<s:property value='picturepath' />" alt="">
							</a>
						</div>
					</s:iterator>
				...
				<div class="row">
					...
					<div class="col-md-4">
						...
						<div class="box-image text-center">
							<a class="image-hover" href="2.html"> <img
									class="img-responsive"
									src="assets/images/demo/600x400/15-min.jpg" alt="" /> </a>

							<a class="box-image-title" href="2.html">
								<h2>
									照明产品
								</h2> </a>
							<p class="font-lato weight-300">
								照明产品宣传广告词，图片替换为照明类宣传图片
							</p>
						</div>
					...
					<div class="col-md-4">
						...
						<div class="box-image text-center">
							<a class="image-hover" href="2.html"> <img
									class="img-responsive"
									src="assets/images/demo/600x400/20-min.jpg" alt="" /> </a>
					...
					<div class="col-md-4">
						...
						<div class="box-image text-center">
							<a class="image-hover" href="2.html"> <img
									class="img-responsive"
									src="assets/images/demo/600x400/25-min.jpg" alt="" /> </a>
								...
								<div class="owl-carousel featured nomargin owl-padding-10"
									...
									<div class="shop-item nomargin">
										...
										<div class="thumbnail">
											...
											<div class="shop-item-counter">
												<div class="countdown"
													data-from="December 31, 2016 08:22:01"
									...
									<div class="shop-item nomargin">
										...
										<div class="thumbnail">
											...
											<a class="shop-item-image" href="3.html"> <!-- CAROUSEL -->
												<div class="owl-carousel owl-padding-0 nomargin"
													...
													<img class="img-responsive"
														src="assets/images/demo/shop/products/300x360/p5.jpg"
														alt="">
													<img class="img-responsive"
														src="assets/images/demo/shop/products/300x360/p1.jpg"
														alt="">
												</div> <!-- /CAROUSEL --> </a>
											<!-- /product image(s) -->
											...
											<div class="shop-item-counter">
												<div class="countdown"
													data-from="December 31, 2017 08:22:01"
													data-labels="年,月,周,天,时,分,秒">
													<!-- Example Date From: December 31, 2018 15:03:26 -->
												</div>
											</div>
										...
										<div class="thumbnail">
											...
											<div class="shop-item-counter">
												<div class="countdown"
													data-from="December 31, 2016 08:22:01"
													data-labels="年,月,周,天,时,分,秒">
													<!-- Example Date From: December 31, 2017 15:03:26 -->
												</div>
											</div>
											<!-- /countdown -->
									...
									<div class="shop-item nomargin">
										...
										<div class="thumbnail">
											...
											<a class="shop-item-image" href="3.html"> <img
													class="img-responsive"
													src="assets/images/demo/shop/products/300x360/p8.jpg"
													alt="shop hover image" /> <img class="img-responsive"
													src="assets/images/demo/shop/products/300x360/p3.jpg"
													alt="shop first image" /> </a>
											<!-- /product image(s) -->
											<!-- countdown -->
											<div class="shop-item-counter">
									...
									<ul class="list-unstyled nomargin nopadding text-left">
										...
										<li class="clearfix">
											...
											<div class="thumbnail featured clearfix pull-left">
												<a href="3.html"> <img
														src="assets/images/demo/shop/products/100x100/p10.jpg"
														width="80" height="80" alt="featured item"> </a>
											</div>
											<a class="block size-1 margin-bottom-10" href="3.html">E27大螺口玉米灯
												5W</a>
										...
										<li class="clearfix">
											...
											<div class="thumbnail featured clearfix pull-left">
												<a href="3.html"> <img
														src="assets/images/demo/shop/products/100x100/p6.jpg"
														width="80" height="80" alt="featured item"> </a>
											</div>
											<a class="block size-1 margin-bottom-10" href="3.html">电工产品名称标题</a>
											<!--div class="rating rating-4 size-13 width-100 text-left">< rating-0 ... rating-5 -></div-->
											<div class="size-12 text-left margin-bottom-8">
												产品简短文字说明
											</div>
										...
										<li class="clearfix">
											...
											<div class="thumbnail featured clearfix pull-left">
												<a href="3.html"> <img
														src="assets/images/demo/shop/products/100x100/p14.jpg"
														width="80" height="80" alt="featured item"> </a>
											</div>
											<a class="block size-1 margin-bottom-10" href="3.html">水暖产品名称标题</a>
											<!--div class="rating rating-4 size-13 width-100 text-left">< rating-0 ... rating-5 -></div-->
											<div class="size-12 text-left margin-bottom-8">
												产品简短文字说明
											</div>
								...
								<div>
									...
									<ul class="list-unstyled nomargin nopadding text-left">
										...
										<li class="clearfix">
											...
											<a class="block size-1 margin-bottom-10" href="3.html">照明产品名称标题</a>
											<!--div class="rating rating-4 size-13 width-100 text-left">< rating-0 ... rating-5 -></div-->
											<div class="size-12 text-left margin-bottom-8">
												产品简短文字说明
											</div>
