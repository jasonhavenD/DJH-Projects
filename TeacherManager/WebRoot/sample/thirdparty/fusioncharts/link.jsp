...
function initComplete(){
	   ...
	   var chart1 = new FusionCharts(chartPath + "Column2D.swf", "ChartId", "100%", "300", "0", "0");
	   chart1.setDataURL(dataUrlPath + "Column2D_2.xml");		   
	   chart1.render("chartdiv1");
	   
	   var chart2 = new FusionCharts(chartPath + "Column2D.swf", "ChartId", "100%", "300", "0", "0");;
	   chart2.setDataURL(dataUrlPath + "Column2D_3.xml");		   
	   chart2.render("chartdiv2");
	   
	   var chart3 = new FusionCharts(chartPath + "Column2D.swf", "ChartId", "100%", "300", "0", "0");;
	   chart3.setDataURL(dataUrlPath + "Column2D_4.xml");   
