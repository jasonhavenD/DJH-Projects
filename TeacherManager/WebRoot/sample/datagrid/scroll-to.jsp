...
<body>
	<div class="box2" panelTitle="表格操作" id="searchPanel">
	   <input type="button" value="滚动到底部" onclick="scrollHandler('bottom',null,false)"/>
		<input type="button" value="滚动到顶部" onclick="scrollHandler('top',null,false)"/>
		<input type="button" value="滚动到底部（缓动）" onclick="scrollHandler('bottom',null,true)"/>
		<input type="button" value="滚动到顶部（缓动）" onclick="scrollHandler('top',null,true)"/>
		<input type="button" value="滚动到右侧" onclick="scrollHandler(null,'right',false)"/>
		<input type="button" value="滚动到左侧" onclick="scrollHandler(null,'left',false)"/><br/>
		<input type="button" value="滚动到右侧（缓动）" onclick="scrollHandler(null,'right',true)"/>
		<input type="button" value="滚动到左侧（缓动）" onclick="scrollHandler(null,'left',true)"/>
		<input type="button" value="滚动到右下侧" onclick="scrollHandler('bottom','right',false)"/>
		<input type="button" value="滚动到左上侧" onclick="scrollHandler('top','left',false)"/>
		<input type="button" value="滚动到右下侧（缓动）" onclick="scrollHandler('bottom','right',true)"/>
		<input type="button" value="滚动到左上侧（缓动）" onclick="scrollHandler('top','left',true)"/>
	</div>
      ...
      {"deptName":"部门2","sex":"女","remark":null,"hobby":["唱歌","跳舞"],"beginworkDate":"2012-06-05 00:00:00.0","photo":null,"version":null,"id":119,"degree":"博士肄业","age":20,"name":"员工12","deptId":6,"ability":5}
       ...
       //数据表格使用
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
                columns: [ 
	                ...
	                { display: '姓名', name: 'name', align: 'center',  width: 500},
	                { display: '性别', name: 'sex', align: 'center' , width: 500},
	                { display: '部门', name: 'deptName',  align: 'center' , width:500},
	                { display: '学历', name: 'degree',  align: 'center', width: 500}
                ], data:testData, pageSize: 50, rownumbers:true, checkbox:true,
        ...
        function scrollHandler(scrollY,scrollX,anmition){
        	g.setScroller(scrollY,scrollX,anmition);
        }
    </script>	
</body>
</html>