		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
                columns: [ 
	                ...
	                { display: '姓名', name: 'name', align: 'center',  width: 200, frozen: true },
	                { display: '性别', name: 'sex', align: 'center' , width: 400},
	                { display: '部门', name: 'deptName',  align: 'center' , width: 400},
	                { display: '学历', name: 'degree',  align: 'center', width: 400 }
                ], data:testData, pageSize: 5, rownumbers:true, checkbox:true,
