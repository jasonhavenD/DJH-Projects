...
.l-layout-drophandle-right{
	background-image: url("<%=path%>/libs/images/formEle/spliter_bg_v.jpg");
       ...
       //数据表格使用
		...
		function initComplete(){
			 ...
			 g = $("#maingrid").quiGrid({
                ...
                ], url: '<%=path%>/getUserdbs.action', pageSize: 10, rownumbers:true, checkbox:false,percentWidthMode:true,sortName:"userId",sortOrder:"desc",
            ...
            g2 = $("#maingrid2").quiGrid({
                ...
                ], url: '<%=path%>/getUsersOfPager.action?parentId=15',  pageSize: 10, rownumbers:true, checkbox:false,percentWidthMode:true,sortName:"userId",sortOrder:"desc",
                height: '100%', width:'100%',showPageInfo:false
            });
		}
