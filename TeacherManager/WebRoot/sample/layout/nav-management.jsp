...
<div class="box1" panelWidth="800">
 ...
 <script type="text/javascript">
	...
	var zNodes1 =[
		{ id:1, parentId:0, name:"系统导航列表",icon:"<%=path%>/libs/icons/list.gif"}
	];
	...
	function addHoverDom(treeId, treeNode) {
		...
		if (btn){ 
		    btn.bind("click", function(){
				var zTree = $.fn.zTree.getZTreeObj("tree-1");
				var newNode;
				newNode = zTree.addNodes(treeNode, {id:(100 + newCount), parentId:treeNode.id, name:"新增" + (newCount++),icon:"<%=path%>/libs/icons/mark.gif"});
				if (newNode) {
