      ...
      {"deptName":"部门2","sex":"女","remark":null,"hobby":["唱歌","跳舞"],"beginworkDate":"2012-06-05 00:00:00.0","photo":null,"version":null,"id":113,"degree":"博士肄业","age":20,"name":"员工12","deptId":6,"ability":5}
		...
		function initComplete(){
			 g = $("#maingrid").quiGrid({
                ...
                ], data:testData, pageSize: 10, rownumbers:true, checkbox:false,percentWidthMode:true,
                height: '100%', width:"100%",onDblClickRow:onDblClickRow
            });
		}
 		...
 		function onDblClickRow(rowdata, rowid, rowobj){
			...
			showProgressBar();
			//调用方法弹出tab
			top.frmright.tabAddHandler(rowdata.id,rowdata.name,"<%=path%>/sample/layout/grid-addtab-content2.jsp");
		}
