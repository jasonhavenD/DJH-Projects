...
<link href="<%=path%>/libs/css/import_basic.css" rel="stylesheet" type="text/css" scrollerX="false"/>
...
<script type="text/javascript">
   function initComplete(){
       ...
       var dataUrlPath = "<%=path%>/libs/thirdparty/fusioncharts/data/";
	    var chart1 = new FusionCharts(chartPath + "Line.swf", "chart3", "100%", "300", "0", "0");
	   chart1.setDataURL(dataUrlPath + "Column2D.xml");		   
