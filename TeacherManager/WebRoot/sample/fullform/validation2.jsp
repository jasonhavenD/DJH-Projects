   ...
   <fieldset>
      <legend>3、ajax验证</legend>
       ...
       <form id="form3" method="post" action="" showOnMouseOver="false">
       		...
       		<tr>
				<td width="100">用户名：</td><td><input type="text" class="validate[required,custom[noSpecialCaracters],ajax[<%=path%>/validateUserName.action|* 用户名已存在!]] float_left"/><span class="star float_left">*</span><div class="validation_info"></div><div class="clear"></div></td>
			</tr>
			<tr>
