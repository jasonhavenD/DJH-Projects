...
<body>
	...
	<form id="myFormId" action="<%=path%>/saveWebform.action" method="post" target="frmright" failAlert="表单填写不正确，请按要求填写！">
	<table class="tableStyle" formMode="transparent">
		<tr>
			...
			<td>自动完成框：</td><td><input type="text" name="webForm.autoComplete" class="autoComplete" url="<%=path%>/form/getItemListByWord.action"/></td>
		</tr>
		<tr>
