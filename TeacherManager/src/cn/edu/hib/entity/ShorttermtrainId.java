...
/**
 * ShorttermtrainId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class ShorttermtrainId implements java.io.Serializable {
	...
	/** default constructor */
	public ShorttermtrainId() {
	}

	/** full constructor */
	public ShorttermtrainId(String trainno, String tno) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ShorttermtrainId))
			return false;
		ShorttermtrainId castOther = (ShorttermtrainId) other;
