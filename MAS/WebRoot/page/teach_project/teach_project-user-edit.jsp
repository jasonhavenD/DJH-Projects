...
if (document.getElementById("rank").value.length == 0) {
	...
	else if (!document.getElementById("rank").value.match(regs)) {
		alert("排名选项数据非法，应为数字");
		document.getElementById("rank").focus();
	}
	...
	confirm("教师工号选项不能为空");
		...
		document.getElementById("modifiU").submit();
	}
}
function Numbers(e)
{
...
return numcheck.test(keychar)
	...
	<body style="background-color:#e4dfd9" >
		<div class="alert alert-info">
			当前位置 专业数据采集 修改教学质量工程成员信息
		</div>
		<form action="teachproject_modifiU.action" id="modifiU" method="post">
			<table class="table table-striped table-bordered table-condensed">
				...
				<tbody>
					<tr>
						<td style="width: 60px;">
							质量工程名称：<font color="FF0000">*</font>
						</td>
						<td>
							<input name="teachprojectuser.teachproject.tprojectName" disabled="true"
								value='<s:property value="teachproject.tprojectName"/>'
								type="text" />
						</td>
						<td style="width: 60px;">
							教师工号/姓名：<font color="FF0000">*</font>
						</td>
						<td>
							<div id="abc" style="display: inline; float: left;">
								<input type="text" name="teachprojectuser.teacher.tno" value='<s:property value="teachprojectuser.teacher.tno"/>'
					...
					<tr>
						<td style="width: 60px;">
							排名：<font color="FF0000">*</font>
						</td>
						<td>
							<input name="teachprojectuser.rank" id="rank"
								value='<s:property value="teachprojectuser.rank"/>'
						...
						<td>
							<input name="teachprojectuser.beizhu"
								value='<s:property value="teachprojectuser.beizhu"/>' type="text" />
						</td>
					</tr>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="99">
							...
							<a href="javascript:modifiU()" class="btn btn-primary add">保存</a>&nbsp;&nbsp;
						</td>
					</tr>
				</tfoot>
			</table>
