...
<script type="text/javascript"
	...
	<body style="background-color:#e4dfd9" >
			...
			<table class="table table-striped table-bordered table-condensed">
							...
							<select size="1" id="cType"
								...
								<s:iterator value="contestTypeList">
									<option value="<s:property value='contestTypeId'/>"
										<s:if test="contestTypeId == findContestModel.contestTypeId">selected="selected"</s:if>
									>
				...
				<tfoot>
					<tr>
						...
						<td align="center">
						<a href="highlevelTalent-edit.jsp"
		...
		<table class="table table-striped table-bordered table-condensed">
			<caption class="t_caption">教学质量工程项目查询结果</caption>
				<thead>
					<tr>
						<td>
							#
