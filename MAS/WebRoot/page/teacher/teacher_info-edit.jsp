...
function modifyEdit() {
	...
	<body style="background-color:#e4dfd9"  onload="init();">
		<div class="alert alert-info">
			...
			<b class="tip"></b>编辑教师信息
		</div>

		<form action="editTeacher.action" id="editTeacher" method="post">
			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tbody id="mytable">
					<tr>
						<td style="width: 60px;">
							教师编号：<span style="color: red;">&nbsp;&nbsp;*</span>
						</td>
						<td>
							<input type="text" name="teacher.tno" maxlength="10"
									 id="tno" onblur="teacherblur();"
									value='<s:property value="teacher.tno" />' />
							<span id="teacherNumberError">（填写10位长度的数字）</span>
						</td>


						<td style="width: 60px;">
							教师姓名:<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
					...
					<tr>
						<td style="width: 60px;">
							教师性别:<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
						<input type="hidden" class="s" value="<s:property value="teacher.sex"/>"/>
					...
					<tr>
						...
						<td>
							<select size="1" id="teacher.degree.degreeNo" name="teacher.degree.degreeNo" >
								<option value="">
									全部类型
								</option>
					...
					<tr>
						<td style="width: 60px;">
							师资类别:<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
						...
						<td>
							<select  size="1"  name="teacher.major.department.dno" class="department"
							id="coll" onchange="collchange();" onblur=" return checkNull('coll','collError');">
								<option value="">
									全部学院
								</option>
								<s:iterator value="departmentList" var="departmentvar">
									<option value="<s:property value='dno'/>" <s:if test="#departmentvar.dno == teacher.major.department.dno">selected="selected"</s:if>>
							...
							<select  size="1"  name="teacher.major.mno" id="major" >
								...
								<s:iterator value="majorList" var="major">
									<option value="<s:property value='mno'/>"
										<s:if test="#major.mno == teacher.major.mno">selected="selected"</s:if>>
					...
					<tr>
						...
						<td style="width: 60px;">
							岗位类型:<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
							<select size="1" id="teacher.jobtype.jobTypeNo" name="teacher.jobtype.jobTypeNo">
								<option value="">
									全部类型
								</option>
						...
						<td>
							<input name="teacher.getScholarYear"
								type="text"
					...
					<tr>
						...
						<td style="width: 60px;">
							学科类别:<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
					...
					<tr>
						<td style="width: 60px;">
							是否双师<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
							<select name="teacher.isDoubleTeacher" id="teacher.isDoubleTeacher" >
								<option value="是"
						...
						<td style="width: 60px;">
							是否工程背景<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
							<select name="teacher.isEngineerBackground" id="teacher.isEngineerBackground" >
								<option value="是"
						...
						<td style="width: 60px;">
							是否具有行业培训<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>


							<select name="teacher.isIndustryBackground" id="teacher.isIndustryBackground">
								<option value="是"
					...
					<tr>
						<td style="width: 60px;">
							实践教学能力培训<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
							<select name="teacher.isPracticeTeachTraining" id="teacher.isPracticeTeachTraining" >
								<option value="是"
						...
						<td style="width: 60px;">
							导师类别<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
						...
						<td style="width: 60px;">
							是否外聘教师<span style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*</span>
						</td>
						<td>
