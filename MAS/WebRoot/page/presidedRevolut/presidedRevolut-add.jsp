			...
			<table class="table table-striped table-bordered table-condensed">
				...
				<tbody id="mytable">
					<tr>
						...
						<td>
								<input type="text" name="prer.rprojectNo" onblur="stublur()" id="rprojectNo"  />
					...
					<tr>
						...
						<td>
								<input type="text" name="prer.teacher.tno" id="tno" onblur="tnochange()" />
						...
						<td>
							<div id="abc" style="display: inline; float: left;">
								<input type="text" name="prer.teacher.tno"
									...
									onfocus="findNames('${userId}')"  value='<s:property value="prer.teacher.tno" />'/>
								<!-- 自动搜索，用于显示搜索结果 -->
								<div id="popup"
						...
						<td>
							<input type="text" name="prer.rpartTeacherNum" id="rpartTeacherNum" onblur="return checkNumber('rpartTeacherNum','rpartTeacherNumError')" />
						...
						<td>
							<input type="text" name="prer.rcost" id="rcost" onblur="return checkNumber('rcost','rcostError')"
								/>
