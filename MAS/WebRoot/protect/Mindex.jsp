...
<!--							 target="maincontener">实验室实习场地</a></div>-->
					...
					<div id="mm2" class="theme-navigate-menu-panel">
						...
						<div><a target="maincontener" href="tBooks/tBooks_initSearch.action?rol=1">出版教材</a></div>
					...
					<div id="mm4" class="theme-navigate-menu-panel">
						...
						<div><span target="maincontener" href="cal/outPrint.action?rol=1">评估结果查询与分析</span></div>
