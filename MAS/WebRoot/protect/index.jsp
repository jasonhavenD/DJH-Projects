...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	...
	<link href="${pageContext.request.contextPath}/lib/themes/insdep/easyui_animation.css" rel="stylesheet" type="text/css">
	<link href="${pageContext.request.contextPath}/lib/themes/insdep/easyui_plus.css" rel="stylesheet" type="text/css">
	<link href="${pageContext.request.contextPath}/lib/themes/insdep/insdep_theme_default.css" rel="stylesheet" type="text/css">
	<link href="${pageContext.request.contextPath}/lib/themes/insdep/icon.css" rel="stylesheet" type="text/css">
	<link href="${pageContext.request.contextPath}/lib/plugins/font-awesome-4.7.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
	...
	<div id="master-layout">
			...
			<div class="theme-navigate">
				<div class="left">
                    ...
                    <a class="easyui-linkbutton" href="${pageContext.request.contextPath}/mainShow/mainShow1.html" target="maincontener" >首页</a>
					...
					<div id="mm3" class="theme-navigate-menu-panel">
						...
						<div><a target="maincontener" href="prevent.jsp">其他情况统计</a></div>
						<div><a
		...
		<div
					...
					<div data-options="region:'center',border:false">
						...
						<div class="easyui-accordion" data-options="border:false,fit:true"
							...
							<div title="评估数据统计">
								<ul class="easyui-datalist" data-options="border:false,fit:true">
									...
									<li><span target="maincontener"
										...
										其他情况统计</span></li>
									<li>3-6
										定性指标统计</li><%--href="teachersummary/summary_initSearch.action?rol=1"
							...
							<div title="辅助信息">
								<ul class="easyui-datalist" data-options="border:false,fit:true">
									<li><a target="maincontener"
										href="Sysuserinfo/modifyUserPassword.action">7-1 用户信息修改</a></li>
								</ul>
							</div>
			...
			<div class="theme-left-minimal">
				<ul class="easyui-datalist" data-options="border:false,fit:true">
					...
					<li><p></p></li>
					<li><p></p></li>
					<li><a href="${pageContext.request.contextPath}/mainShow/mainShow1.html" target="maincontener"><i class="fa fa-book fa-2x"></i>
						<p>首页</p></li></a>
		...
		<div data-options="border:false,region:'center'" id="control" style="background:#fff;">
			<iframe style="padding:10px" src="${pageContext.request.contextPath}/mainShow/mainShow1.html" width="100%" height="100%"
