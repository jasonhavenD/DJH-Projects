	...
	<div id="master-layout">
			...
			<div class="theme-navigate">
				<div class="left">
                    ...
                    <a class="easyui-linkbutton" href="${pageContext.request.contextPath}/page/common/main-t.jsp" target="maincontener" >首页</a>
...
<!--							 target="maincontener">实验室实习场地</a></div>-->
					...
					<div id="mm2" class="theme-navigate-menu-panel">
						...
						<div><span target="maincontener" href="fia/initSearch.action?rol=1">定型数据上传</span></div><div><span target="maincontener" href="tBooks/tBooks_initSearch.action?rol=1">出版教材</span></div>
						<div><span target="maincontener" href="presidedRevolution/prerInitSearch.action?rol=1">主持教改项目</span></div>
						<div><span target="maincontener" href="teachproject/teachproject_initSearch.action?rol=1">教学质量工程</span></div>
						<div><span target="maincontener" href="teachResultBase/teachResultBase_initSearch.action?rol=1">教学成果奖</span></div>
						<div><span target="maincontener" href="tea/initSearchtea.action?rol=1">教学经费使用情况</span></div>
...
<!--					<div id="mm6" class="theme-navigate-menu-panel">-->
<!--						<div><a-->
<!--							 href="Sysuserinfo/initSearch.action?rol=1"-->
<!--							 target="maincontener">用户管理</a></div>-->
<!--						<div><a-->
<!--							 href="Sysrole/initSearch.action?rol=1"-->
<!--							 target="maincontener">角色管理</a></div>-->
<!--						<div><a-->
<!--							 href="SysFunmodle/initSearch.action?rol=1"-->
<!--							 target="maincontener">功能管理</a></div>-->
<!--				</div>-->
...
<!--									<li><a-->
<!--										href="department/initSearch.action?rol=1" target="maincontener">1-5 学院信息</a></li>-->
<!--										<%--<li><a-->
<!--										href="prevent.jsp"-->
<!--										target="maincontener">编码表</a></li>--%>-->
<!--										<li><a-->
<!--										href="trainingvenue/initSearchtra.action?rol=1"-->
<!--										target="maincontener">1-6 实验室实习场地</a></li>-->
								</ul>
							</div>
							<div title="专业数据采集">
								<ul class="easyui-datalist" data-options="border:false,fit:true">
...
<!--								<ul class="easyui-datalist" data-options="border:false,fit:true">-->
<!--									<li>-->
<!--										<a target="maincontener"-->
<!--										href="Sysuserinfo/initSearch.action?rol=1">6-1 用户管理</a></li>-->
<!--									<li><a target="maincontener"-->
<!--										href="Sysrole/initSearch.action?rol=1">6-2 角色管理</a></li>-->
<!---->
<!--									<li><a target="maincontener"-->
<!--										href="SysFunmodle/initSearch.action?rol=1">6-3 功能管理</a></li>-->
<!---->
<!--								</ul>-->
<!--							</div>-->
							<div title="辅助信息">
			...
			<div class="theme-left-minimal">
				<ul class="easyui-datalist" data-options="border:false,fit:true">
					...
					<li><p></p></li>
					<li><p></p></li>
					<li><a href="${pageContext.request.contextPath}/page/common/main-t.jsp" target="maincontener"><i class="fa fa-book fa-2x"></i>
						<p>首页</p></li></a>
		...
		<div data-options="border:false,region:'center'" id="control"
			...
			<iframe src="${pageContext.request.contextPath}/page/common/main-t.jsp" width="100%" height="100%"
	...
	第三方插件加载-->
	<!--<script src="${pageContext.request.contextPath}/lib/plugins/justgage-1.2.2/raphael-2.1.4.min.js"></script>
	<script src="${pageContext.request.contextPath}/lib/plugins/justgage-1.2.2/justgage.js"></script>


	<script src="${pageContext.request.contextPath}/lib/plugins/Highcharts-5.0.0/js/highcharts.js"></script>


	<script type="text/javascript" src="${pageContext.request.contextPath}/lib/plugins/ueditor-1.4.3.3/ueditor.config.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/lib/plugins/ueditor-1.4.3.3/ueditor.all.min.js"></script>


	<link href="${pageContext.request.contextPath}/lib/plugins/cropper-2.3.4/dist/cropper.min.css" rel="stylesheet" type="text/css">
	<script src="${pageContext.request.contextPath}/lib/plugins/cropper-2.3.4/dist/cropper.min.js"></script>
