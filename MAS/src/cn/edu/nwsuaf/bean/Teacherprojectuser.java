...
/**
 * Teacherprojectuser entity. @author MyEclipse Persistence Tools
 */

public class Teacherprojectuser  implements java.io.Serializable {
    ...
    /** default constructor */
    public Teacherprojectuser() {
    }

    
    /** full constructor */
    public Teacherprojectuser(Teacher teacher, Teachproject teachproject, String beizhu, Integer rank) {
