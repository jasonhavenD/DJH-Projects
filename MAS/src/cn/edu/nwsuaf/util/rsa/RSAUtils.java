...
public class RSAUtils {
	 ...
	 * @throws Exception
	 */
	public static byte[] sign(String type, byte[] msgBytes,
	 ...
	 * @throws Exception
	 */
	public static boolean verify(String type, byte[] msgBytes,
			PublicKey publicKey, byte[] signatureBytes) throws Exception {
		// 实例化Signature，用于产生数字签名，指定用RSA和SHA算法
		Signature sig = Signature.getInstance(type);
		// 用私钥来初始化数字签名对象
